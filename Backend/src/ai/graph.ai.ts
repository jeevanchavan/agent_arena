...
const judgeNode: GraphNode<typeof state> = async (state) => {
    ...
    const judgeResponse = await structuredModel.invoke([
        new SystemMessage(`You are a judge tasked with evaluating two solutions generated by different AI models. Please provide a score out of 10 for each solution, along with your reasoning for the scores.`),
        new HumanMessage(`
Problem: ${problem}
